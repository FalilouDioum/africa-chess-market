  ...
  return (
    <div>
      ...
      <section className="bg-forest py-12 sm:py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl 2xl:max-w-[1500px] mx-auto px-4 sm:px-6 xl:px-10 hero-fade">
      ...
      <div className="max-w-7xl 2xl:max-w-[1500px] mx-auto px-4 sm:px-6 xl:px-10 py-8 sm:py-12">
        <FadeIn>
