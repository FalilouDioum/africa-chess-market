            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              >
                ...
                <span className="flex flex-col leading-tight">
                  <span>WhatsApp</span>
                  <span className="text-[10px] font-normal text-white/70">Tous les jours 08h-19h</span>
                </span>
              </a>
            </nav>
        ...
        <div className="px-5 pb-6">
          ...
          >
            ...
            <span className="flex flex-col leading-tight">
              ...
              <span className="text-xs font-normal text-white/70">Tous les jours 08h - 19h</span>
            </span>
          </a>
        </div>
      </div>
